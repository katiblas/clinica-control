...
<label  class="text-success "><a href="../usuario/usuario.php?usua=<?php echo $usuario;?>" class="list-group-item active"><img src="../icon/paciente.png" style="width: 30px; border-radius: 5px;"><label>Bienvenido</label> &nbsp; <?php echo "".""."" .$usuario; ?> </a></label><br>
<label><a href="destruir.php">Salir</a></label>
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="../consultas/buscar-consulta.php?usua=<?php echo "".$usuario;?>"><img src="../icon/buscar (2).png" style="width: 20px;"> Buscar Consultas</a></li>

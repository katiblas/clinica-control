...
<section>
	...
	<form action="incluir.php?usua=<?php echo $usuario;?>" method="post" name="frm">
...
<table border="0"  class="table" >
	...
	<tr>
	<td>Nombre</td>
		<td><input type="text" name="nombre" id="nombre"  maxlength="25" required onKeyPress="return sololetras();"></td>
</tr>
<tr>
	<td>Apellido</td>
		<td><input type="text" name="apellido" id="apellido" maxlength="25" required onKeyPress="return sololetras();"></td>
</tr>
	
<tr>
	<td>Edad</td>
	<td><input type="text" name="edad" id="edad" onKeyPress="return SoloNumeros(event);"></td>
	</tr>
	<tr>
	<td>Direccion</td>

...
<section>
	<form action="../usuario/modificar2.php?usua=<?php echo "" .$usuario;?>&id=<?php echo "" .$_GET['id_usu']; ?>" method="get" name="frm">
...
?>
	<tr>
		...
		<td><input type="hidden" name="id_usu" id="id_usu" required readonly value="<?php echo "" .$rows['id_usu'];?>"></td>
	</tr>

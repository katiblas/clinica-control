...
<div class="container-fluid bg-2 ">
  <a href="../usuario/usuario2.php?usua=<?php echo "" .$usuario1;?>"><img src="../icon/atras.png" style="width: 40px; margin: 10px;" alt="Bird"></a>
    </div>
 ...
 $sql1 = "SELECT * FROM usuarios where usuario='".$usuario1."'";
  ...
  $rows=mysql_fetch_array( $RESULT); 
    ...
    ?>
        ...
        <form action="modificar-listo2.php?id=<?php echo "" .$rows['id_usu'];?>&usua=<?php echo "" .$usuario; ?>" method="get" name="fomr">

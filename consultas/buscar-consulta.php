...
<div class="container-fluid bg-2 ">
    <a href="../menu-usua/index.php?usua=<?php echo "".$usuario; ?>"><img src="../icon/atras.png" style="width: 40px; margin: 10px;" alt="Bird"></a>
    
 
    </div>
    <ul class="nav navbar-nav navbar-left">
    <li class="h4"><a href="../reporte/mayor-consulta.php?usua=<?php echo $usuario;?>">   Listar Todas</a></li>
...
<tr><td>
   ...
   <td> <input type="submit" id="btn_submit" name="btn1" value="Buscar" class="btn-success"></td>
</tr>
    </table>
</form>
...
<?php } ?>
<center>
  <a href="../reporte/reporteConsulta.php?usua=<?php echo  "" .$usuario;?>&ini=<?php echo "" .$START_DATE;?>&fina=<?php echo "" .$END_DATE;?>" target="_blank">

...
$result = mysql_query("SELECT p.ci_p,p.nombre,p.cod_enf,p.apellido,p.edad,p.direccion,p.sexo,e.nombre_enf as nombre_enf from paciente p INNER JOIN enfermedades e where p.cod_enf=e.cod_enf and sexo='Masculino'" ) ; 

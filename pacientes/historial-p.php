...
<section>
  <form action="buscar-paciente3.php?usua=<?php echo "".$usuario; ?>" method="get" >
...
<br>
  ...
  <!--<a href="../reporte/reporte-historial.php?usua=<?php echo  "" .$usuario;?>&ci_p=<?php echo"" .$ci_p ?>" target="_blank" >
